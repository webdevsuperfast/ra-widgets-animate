/**
 * Gutenberg Block Editor Support for RA Widgets Animate
 */
            ...
            {rawaAnimationType && (
              <>
                <SelectControl
                  ...
                  onChange={(value) =>
                    setAttributes({ rawaAnimationEasing: value })
                  }
                />
                <TextControl
                  label={__("Threshold")}
                  ...
                  onChange={(value) =>
                    setAttributes({ rawaAnimationOffset: value })
                  }
                ...
                <TextControl
                  ...
                  onChange={(value) =>
                    setAttributes({ rawaAnimationDuration: value })
                  }
                ...
                <TextControl
                  ...
                  onChange={(value) =>
                    setAttributes({ rawaAnimationDelay: value })
                  }
                ...
                <ToggleControl
                  ...
                  onChange={(value) =>
                    setAttributes({ rawaAnimationOnce: value })
                  }
...
// Modify block save to add data-usal attributes
addFilter(
  ...
  (element, blockType, attributes) => {
    ...
    if (attributes.rawaAnimationType) {
      const mappedAnimation =
        animationMap[attributes.rawaAnimationType] ||
        attributes.rawaAnimationType;
      usalParts.push(mappedAnimation);
    }

    if (
      attributes.rawaAnimationDuration &&
      attributes.rawaAnimationDuration !== "0"
    ) {
    ...
    if (usalParts.length > 0) {
      ...
      // Add data-usal attribute to the element
      if (element) {
        return {
          ...element,
          props: {
